...
public class RainfallForm extends JFrame {
	 ...
	 */
	public RainfallForm() {
		setTitle("BMeyer 2740 Ex3H Rainfall");
		...
		lblMonthlyRainfall.setBounds(10, 11, 99, 14);
		...
		monthList.setBounds(20, 36, 47, 220);
		...
		avgLabel.setBounds(232, 73, 46, 14);
		...
		maxLabel.setBounds(231, 110, 46, 14);
		...
		minLabel.setBounds(232, 143, 46, 14);
		...
		calculateButton.setBounds(187, 175, 91, 23);
		...
		inputMonthTextField.setBounds(77, 271, 31, 20);
		...
		updateButton.setBounds(132, 252, 91, 23);
